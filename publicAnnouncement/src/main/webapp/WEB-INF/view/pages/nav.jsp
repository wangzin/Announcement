<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	<div class="container">
		<a class="navbar-brand pull-left" href="#">Post and get job of your choice!</a>
		...
		<div class="collapse navbar-collapse " id="navbarResponsive">
			<ul class="navbar-nav ml-auto pull-right" >
				...
				<li class="nav-item" id="vacancy"><a class="nav-link" href="${contextRoot }/Vacancy">Vacancies</a></li>
